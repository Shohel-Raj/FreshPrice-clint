...
const Home = () => {
  ...
  return (
    <>
      ...
      {/*--------------- Product Section ---------------*/}
      <Seperatesection color="bg-white dark:bg-gray-900">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {data?.map((d) => (
              <ProductCard key={d.marketName} product={d} />
            ))}
          </div>
        </Container>
      </Seperatesection>
      ...
      {/* ---------- Advertisement -----------*/}
      <Seperatesection color="bg-gray-100 dark:bg-gray-800">
        <Container>
          <div className="py-3.5">
            <h1 className="font-bold text-2xl md:text-3xl uppercase italic mb-3 text-center text-[#FBD536]">
      ...
      <Seperatesection color="bg-gray-100 dark:bg-gray-800">
        <Container>
          <div className="py-3.5">
            ...
            <p className="md:w-3/4 mx-auto mb-6 text-center text-sm text-gray-600 dark:text-gray-300">
